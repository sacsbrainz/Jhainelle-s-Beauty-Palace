    ...
    <div className='relative   bg-slate-900 font-poppins-regular'>
      ...
      <div className='no-scrollbar flex flex-col text-center text-[#d0d1d5] '>
        <div className='flex h-full  w-full flex-col items-center justify-center gap-4 py-20 px-4 md:gap-6 md:px-10'>
          ...
          <div>
            <div className='flex flex-row gap-4 '>
              <a href='https://www.instagram.com/jhainellesbeautypalace'>
        ...
        <div id='#testimonies'>
          ...
          <div className='carousel carousel-center rounded-box w-full space-x-4 bg-neutral p-4'>
            <div className='carousel-item'>
              <img
                src='Images/1.jpeg'
                className='rounded-box aspect-square h-[40vh] w-[50vw] object-cover'
              />
            </div>
            <div className='carousel-item'>
              <img
